package com.jpmc.training.userdefinedconnector;
...
public class MyFileStreamSourceConnector extends SourceConnector {
  ...
  public void start(Map<String, String> props) {
      ...
      if(filename==null) {
          System.out.println("file configuration missing --- using default file c:/sample/ctest.txt");
          filename="c:/sample/ctest.txt";
      }
